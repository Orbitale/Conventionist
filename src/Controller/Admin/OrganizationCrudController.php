...
final class OrganizationCrudController extends AbstractCrudController
{
    ...
    public function configureActions(Actions $actions): Actions
    {
        ...
        $actions
            ...
            ->setPermission(Action::DELETE, OrganizationVoter::CAN_DELETE_ORGANIZATION);
    ...
    /**
     * @param Organization $entityInstance
     */
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            Field\UrlField::new('website')->setRequired(false),
            Field\TextField::new('logoPath')->setRequired(false)->hideOnIndex(),
