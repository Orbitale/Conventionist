    ...
    public static function getStaticData(): array
    {
        return [
            '322c94a8-ab40-41c6-b272-d605d03e068f' => [
                'name' => 'TDC 2025',
                'slug' => 'tdc-2025',
                'startsAt' => (new \DateTimeImmutable('+100 days'))->setTime(0, 0, 0, 0),
                'endsAt' => (new \DateTimeImmutable('+120 days'))->setTime(0, 0, 0, 0),
            ...
            '36b1b285-ec34-49e4-b462-93a313995cc9' => [
                'name' => 'Custom event',
                'slug' => 'custom-event',
                'startsAt' => (new \DateTimeImmutable('+200 days'))->setTime(0, 0, 0, 0),
                'endsAt' => (new \DateTimeImmutable('+220 days'))->setTime(0, 0, 0, 0),
